...
총 Mock 세션 25 (실제 9). `Deferred-X`(증권사 API·매뉴얼 트레이딩 UI)는 **2026-04-21 S8로 승격** (Slices/S8-AutoTrading.md). S7(실데이터 전환) · S8(자동매매: 주식 KIS + 바이낸스 선물) · S9(운용 검증)은 HANDOFF.md §2 Runbook(S7b~S9 후속 PR + 운영) 참조.
