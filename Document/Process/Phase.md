...
| 소스 | 사용 Task |
|---|---|
| **OMC 에이전트** | 1.1(analyst), 1.2(document-specialist), 1.7(document-specialist), 1.8(architect+scientist 보조), 3.5(information-architect), 4.1(product-manager), 4.3(product-analyst), 4.5(writer), 5.1(critic), 5.2(ux-researcher) |
...
| P1 | P0 합의 완료 | `.omc/research/*` (gap-analysis, competitors, committee-ux-patterns, quant-data-architecture) + ServicePlan §3 관련 섹션 초안 |
