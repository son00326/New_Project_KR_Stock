...
| Supabase | project `rbrpcynhphrpljbjirfo` · **0001~0030 production applied** (0028/0029/0030) · **0031 = W2a 재작성본(period_key/track job·run + `replace_shortlist_track`/`carry_short_into_month`/`claim_next_selection_jobs`(period_key) RPC), dormant = USER apply 대기**(미적용 확인 후 apply — 적용됐다면 신규 마이그 필요) · SECURITY DEFINER 패턴 · dart_corp_codes 2,766/2,766 induty 백필. |
