...
| 영역 | 상태 |
|---|---|
| main HEAD | **runtime verify** `git rev-parse --short origin/main`. **2026-06-25: `tier0-bpp-multiregime`(72 commits = B++ funnel/shadow PR-A·B/PR-T2a/B-PARTB) FF-merged → main `ea27656` + Vercel prod 배포** — 기존 'main 미머지' 표기 다수 stale, 비-B-PARTB 코드는 flag-gated/dormant. (직전 285339a 77차 PR #122.) |
