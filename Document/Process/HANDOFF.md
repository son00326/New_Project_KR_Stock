...
#    Path-A sector UI는 pre-launch 비교 메뉴(핵심 = production B++ 30 vs Track2 sector-soft-tilt(B++ + 섹터) 30)로 이동; PR-A5/PR-B5 통계 verdict는 연구 레이어이며 main 미머지 상태를 runtime verify.
