...
- **51차 PR #3 + #1 머지 + Tier 2 R3~R7 brainstorm CONVERGED (2026-05-20)**:
  ...
  - **다음 1순위 (52차)**: **Tier 2 SoT PR** 작성 — ServicePlan-Admin §7.2 10 slot + 4 overlay 명세 갱신 / §7.3 14 sector + sub_tags mapping 표 / §6 D20 14명 = 10 base + 2 primary + 2 sub_tag overlay 정정 / ReportFramework §7.2 slot 4 ambiguity 해소 / `tudal/src/lib/screening/canonical-sectors.ts` 신규 (alias map + sub_tags crosswalk) + 마이그 0018 + tests. 별도 branch 기준 main fresh. 그 후 Tier 2 implementation PR.
