...
### S7b · 뉴스 기반 자동 제외 (M12a) + 모닝 브리핑 (M11)
> **(72차 재정의)** S7b = (a) **뉴스 기반 자동 제외**(AI 페르소나) + (b) M11 모닝 브리핑. 구 "수동 브리핑 요약 + 규칙기반 3등급 분류" supersede. spec SoT = `ServicePlan-Admin.md §3.10 M12a`. **AI 페르소나·자동 제외 로직은 planned(미구현).**
