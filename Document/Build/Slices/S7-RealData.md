...
- [ ] **T7e.8 (D19, 2026-05-08 35차) Tier 0 인디케이터 자동 스크리닝 — AI 키 불필요**:
  ...
  - **42차 진척 (2026-05-12)**:
    ...
    - ⏸ Tier 0 실 시드 (실 30종목 INSERT)는 venv + pykrx + service_role 환경변수 세팅 후 사용자 측 수동 실행 — `python3 scripts/screen_shortlist_tier0.py --month 2026-05-01 --dry-run --csv-backup ...` → CSV inspect → `--apply`로 본 적용. DART 실 재무 시그널은 후속(T7e.8 follow-up/S7a).
