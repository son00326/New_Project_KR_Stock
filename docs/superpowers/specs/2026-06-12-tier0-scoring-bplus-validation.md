...
- **[2026-06-19 SUPERSEDED]** ~~--apply/Tier1 보류 — 삼중 게이트 ALL PASS 후만~~ → USER 운영 funnel 승인으로 B++ --apply 허용(상단 UPDATE·HANDOFF ★). production `tier0_candidates_150`/`short_list_30` 2026-06 = **여전히 73차(B++ --apply 전 — 다음 세션 G1에서 교체)**.
