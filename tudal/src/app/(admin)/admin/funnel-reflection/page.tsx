...
export default async function FunnelReflectionPage() {
  ...
  return (
    <div className="space-y-6">
      <header>
        <h1 className="text-2xl font-semibold">Tier0 Reflection Lab (G1)</h1>
      ...
      {loadError && (
        <p className="rounded-md border border-yellow-500 bg-yellow-500/10 px-3 py-2 text-xs text-yellow-700 dark:text-yellow-400">
