...
> = {
  "바이오": {
    ...
    global_industry_veteran: "글로벌 빅파마/바이오텍 전직 임원 시각. 글로벌 라이센싱 deal·FDA fast-track 지정·신약허가신청(NDA/BLA) 진행 단계·소분자 vs biologics 균형을 본다.",
  ...
  "반도체": {
    ...
    global_industry_veteran: "글로벌 파운드리/메모리 전직 엔지니어/임원 시각. 글로벌 메모리 가격·OEM 고객 다변화·중국 수출 통제 영향을 본다.",
  ...
  "건설": {
    ...
    global_industry_veteran: "글로벌 대형 EPC 임원 시각. 해외 수주 마진·환율 hedging·중동/동남아 시장 점유율을 본다.",
  ...
  "금융": {
    ...
    global_industry_veteran: "글로벌 IB 임원 시각. 글로벌 자본 이동·달러 funding cost·핀테크 disruption을 본다.",
  ...
  "IT/SW": {
    ...
    global_industry_veteran: "글로벌 SaaS/하이퍼스케일러 전직 임원 시각. 글로벌 SaaS unit economics·API 생태계·platform vs commodity 위험을 본다.",
    global_adjacent_expert: "통신·미디어·금융 인접 시각. SaaS의 산업별 vertical 진출·M&A 가능성·OEM 통합을 본다.",
  },
  "2차전지": {
    domestic_special_expert: "국내 배터리 셀 공정 엔지니어/제조 PM 시각. LFP/NCM mix 변화·수율·CAPEX 회수 일정·국내 셀 메이커 고객 다변화를 본다.",
    domestic_academic: "국내 화학공학 학계 시각. 전고체·리튬황·실리콘 음극재 등 차세대 배터리 학술 동향·핵심 IP·핵심 인재 풀을 본다.",
    global_industry_veteran: "글로벌 셀 메이커 전직 임원 시각. 글로벌 EV 보급 곡선·OEM 수주 변화·중국 본토 가격 경쟁을 본다.",
    global_adjacent_expert: "EV 완성차·ESS·전력 인프라 인접 시각. 배터리와 OEM 통합·ESS 시장 진입·리튬/니켈/코발트 원자재 통합·재활용 시장 진입을 본다.",
  },
  "자동차": {
    domestic_special_expert: "국내 OEM 또는 핵심 부품사 출신 PM 시각. EV 라인 전환·자율주행 ECU sourcing·중국 시장 점유율 회복을 본다.",
    domestic_academic: "국내 자동차공학 학계 시각. 자율주행(L3·L4) 알고리즘·전기 powertrain·SDV(Software-Defined Vehicle) 학술 동향을 본다.",
    global_industry_veteran: "글로벌 OEM 전직 임원 시각. 글로벌 OEM sourcing·자율주행 robotaxi·중국 NEV·미국 IRA 영향을 본다.",
  ...
  "유통/소비재": {
    ...
    global_industry_veteran: "글로벌 retail/소비재 전직 임원 시각. 글로벌 retail 마진 trend·DTC 침투율·물류 비용·해외 K-소비재 확장을 본다.",
  ...
  "엔터/미디어": {
    ...
    global_industry_veteran: "글로벌 OTT/음악 레이블 전직 임원 시각. 글로벌 OTT 콘텐츠 acquisition·K-콘텐츠 라이센싱 마진·아티스트 360 deal을 본다.",
  ...
  "운송/물류": {
    ...
    global_industry_veteran: "글로벌 해운/항공 cargo 전직 임원 시각. 글로벌 BDI/SCFI·항공 cargo 시장·운하 통과량·코로나 후 정상화 속도를 본다.",
  ...
  "보험/증권": {
    ...
    global_industry_veteran: "글로벌 보험/자산운용 전직 임원 시각. 글로벌 자산운용 trend·alternatives·ESG·active vs passive 시장 점유율을 본다.",
