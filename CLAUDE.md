...
Mock Skeleton ✅
  ...
  → S7a (Anthropic wrapper) ✅ 완료 (PR #1 `61653d22`) · 실 AI 첫 30선정(PR-G ⓑ) 진입 대기 — Anthropic 키 발급 + 비용 승인 게이트
  ...
  → S7b (뉴스+브리핑)
  → ★ D11 AI 가상 포트 1차 가동 (KIS 0개 · 진입 전 위 hard gate 완료 필수 · **메인 path = Tier 0 + Tier 1 AI 합의 + Tier 2 plug-in** · fallback = AI 키 미발급 시 Tier 0 단독 30 직선정)
