...
Mock Skeleton ✅
  ...
  → S7a (Anthropic wrapper) ✅ 완료 (PR #1 `61653d22`) · 실 AI 첫 30선정 진입 대기 — 65차 supersede: PR-G ⓑ 단발 → W0✅→W2a✅→W2b✅→W1a✅→W1b✅→W3a✅→W3b-1✅→W3b-2a✅→W3b-2b✅→W3b-3로 분해, 코드자산 재사용 (상세 HANDOFF §2 ⭐ 65차 MVP 엔진)
  → **Tier 2 D21 (52차)** ── ✅ **scaffold + production schema MERGED in main** (PR #4 + PR #5 + PR #6 historical, 마이그 0018·0019 production applied)
       ...
       · **출시 Runbook 진입점 = `Document/Process/HANDOFF.md §2`** (현재 위치·다음 1순위 live SoT = HANDOFF) · W3b-2b merge main `96c91b5` + docs-sync main `af0cbf3` 기준 canonical 5-PR + e2e engine PR-D~PR-G ⓐ + launch-readiness PR #79(A~E) + 67차 W2a ✅(PR #89) + 68차 W2b ✅(PR #91) + 68차 W1a ✅(PR #92+#93) + 68차 W1b ✅(PR #94+#95) + 68차 W3a ✅ MERGED(PR #96) + 69차 W3b-1 ✅ MERGED(PR #97, code-merge `6b118bc`) + 69차 W3b-2a ✅ MERGED(PR #98, main `c1ee610`) + 69차 W3b-2b ✅ MERGED(PR #99, main `96c91b5`) → **다음 1순위 = `W3b-3`(admin UI) 또는 `W3b-2c`(선택 refinement)** (65차 supersede: PR-G ⓑ → W0✅→W2a✅→W2b✅→W1a✅→W1b✅→W3a✅→W3b-1✅→W3b-2a✅→W3b-2b✅→W3b-3로 분해 · USER 게이트 = `SELECTION_CRON_AUTO_ENABLED`+키/비용 + 주간 tier0 producer + 0032·0033 apply + (W3a) PORTFOLIO_REAL_ENTRY_PRICE_ENABLED+KRX_OPENAPI_KEY + (W3b-1 실 Opus) PORTFOLIO_AI_PROPOSAL_ENABLED+ANTHROPIC_API_KEY+AI_COST_LOG_REAL_INSERT_ENABLED + (W3b-2a 영속) PORTFOLIO_PROPOSAL_PERSIST_ENABLED+마이그 0034 apply + (W3b-2b Accept weight) PORTFOLIO_USE_PROPOSAL_ENABLED, 상세 HANDOFF §2 ⭐ 65차 MVP 엔진)
       · 다음 1순위 = **canonical 5-PR 전체 MERGED (PR2 `f85fb69` / PR3a `0813a41` / PR1 `4aa3130` / PR3b `cf68731` / PR3c `b2a902a` / PR4 `7de9696`) + e2e engine PR-D~PR-G ⓐ + launch-readiness PR #79(A~E) + **67차 W2a ✅(PR #89) + 68차 W2b ✅(PR #91) + 68차 W1a ✅(PR #92+#93) + 68차 W1b ✅(PR #94+#95) + 68차 W3a ✅ MERGED(PR #96) + 69차 W3b-1 ✅ MERGED(PR #97, code-merge `6b118bc`) + 69차 W3b-2a ✅ MERGED(PR #98, main `c1ee610`) + 69차 W3b-2b ✅ MERGED(PR #99, main `96c91b5`)** → **다음 1순위 = `W3b-3`(admin UI) 또는 `W3b-2c`(선택 refinement)** (빌드 순서 W0✅→W2a✅→W2b✅→W1a✅→W1b✅→W3a✅→W3b-1✅→W3b-2a✅→W3b-2b✅→W3b-3 · 65차 supersede: PR-G ⓑ 단발 → 분해)** · Reflection/PR-K = 출시 게이트 아님 (S9/go-live 후 defer) · (65차 MVP 재정의: 출시 핵심 = ①30리스트 ②포트폴리오 ③30리포트 정확. W0~W3가 MVP 경로, 고도화 아님) · 상세·중간 단계 live SoT = HANDOFF §2
